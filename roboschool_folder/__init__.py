...
# NIR  pg_complexity 8->12 ?

register(
    id='RoboschoolMutant-v1',
    entry_point='roboschool:RoboschoolMutant',
    max_episode_steps=1000,
    reward_threshold=2500.0,
    tags={ "pg_complexity": 12*1000000 },
    )
...
from roboschool.gym_nir_walkers import RoboschoolMutant
